...
export const DigitalDrawsCard = () => {
    return (
        <>
            <div className="flex m-8 p-20 h-[850px]">
                <div className="border-2 border-blue-900/80 box-border grow-0 relative min-w-[850px]">
                    <Image
                        src={"/mando.png"}
                        fill
                        alt=""
                ...
                <div className="border-2 border-transparent box-border text-blue-900/80">
                    <h1 className="text-6xl m-6 text-blue-900/80">
                        Titulo provisional aaaaaaaa
                    </h1>
                    <h2 className="text-3xl m-12 text-blue-900/80">AUTOR</h2>
